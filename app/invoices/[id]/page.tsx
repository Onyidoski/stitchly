    ...
    return (
        <div className="min-h-screen bg-slate-50 p-4 md:p-8 font-sans">
            ...
            >
                ...
                {/* 1. HEADER */}
                <div className="p-6 md:p-8 border-b flex justify-between items-start bg-slate-50/50 print:bg-white">
                    ...
                    <div className="text-right">
                        <h2 className="text-2xl md:text-3xl font-light text-slate-300 uppercase tracking-widest">Invoice</h2>
                ...
                <div className="p-6 md:p-8 pb-4">
                    ...
                    <h3 className="text-lg font-semibold text-slate-900">{order.clients?.name}</h3>
                ...
                <div className="p-6 md:p-8 pt-0 flex flex-col sm:flex-row justify-end">
                    <div className="w-full sm:w-64 space-y-3">
                        ...
                        <div className="border-t pt-3 flex justify-between items-center">
                            ...
                            <span className={`text-xl font-bold ${isPaid ? 'text-emerald-600' : 'text-slate-900'}`}>
                                ₦{balance.toLocaleString()}
                            </span>
                        </div>
                        
                        <div className="pt-4 flex justify-end">
                            <div className={`px-4 py-1 border-2 rounded uppercase text-xs font-bold tracking-widest rotate-[-10deg] ${
                                isPaid 
                ...
                {/* 5. FOOTER */}
                <div className="p-6 md:p-8 bg-slate-50 border-t mt-8 print:bg-white print:border-t-2">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="md:text-right">
                            ...
                            <p className="mt-4 font-handwriting text-xl text-slate-900">Thank You!</p>
                        </div>
                    </div>
                </div>
            </div>
